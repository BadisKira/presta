...
class AppointmentDomainServiceTest {
    ...
    void testCanCreateAppointment_RejectsWrongDayOfWeek() {
        ...
        // Then
        assertFalse(canCreate, "Le RDV ne devrait pas être possible le mardi si seulement lundi est disponible");
    }
    ...
    void testCanCreateAppointment_BlockedByUnavailability() {
        ...
        boolean canCreate = service.canCreateAppointment(
                ...
                30,
                List.of(rule),
                List.of(unavailability), // Avec indisponibilité
                List.of()
        );

        // Then
        assertFalse(canCreate, "Le RDV ne devrait pas être possible pendant une indisponibilité");
    }
    ...
    void testCanCreateAppointment_ConflictWithExistingAppointment() {
        ...
        // Then
        assertFalse(canCreate, "Le RDV ne devrait pas être possible si le créneau est déjà pris");
    }
